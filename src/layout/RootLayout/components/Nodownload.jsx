...
const Nodownload = () => {
  ...
  const cardsData = [
    {
      imageUrl: "/public/ChampionsTrophy.jpg",
  ...
  return (
    <>
      <div>
        <div>
          <h1 className='text-4xl flex flex-col gap-1 font-bold items-center justify-center'>
            ...
            <span className='text-5xl font-bold text-[#ff9301]'>premium membership</span>
          </h1>
        </div>
        ...
        <div className='flex flex-col items-center justify-center gap-4 mt-8'>
          <h1 className='text-xl'>All this for only <span className='text-blue-800'> $8</span> a month</h1>
          <button onClick={gosignup} className='py-2 px-7 rounded-lg text-white text-xl bg-[#ff9301]'>Sign up to upgrade</button>
          <h1 onClick={handleOpenModal} className='text-lg font-bold text-[#ff9301] cursor-pointer'>Terms and Conditions</h1>
        </div>
      </div>
      ...
      {isModalOpen && (
        ...
        >
          <div className="max-w-3xl mx-auto p-6 bg-white shadow-md rounded-lg" style={{ maxHeight: '80vh', overflowY: 'auto' }}>
