    ...
    return (
        <div className='p-12'>
            ...
            <div className='border p-6 rounded-lg '>
                ...
                <h3 className='text-gray-400 text-sm mb-6'>Please enter your payment details</h3>

                {/* Card Holder and Card Number */}
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-4'>
                    <div>
                        <label className='block text-gray-700 font-bold mb-1'>Card Holder</label>
                        <input
                            type="text"
    ...
    return (
        <div className='p-12'>
            ...
            <div className='border p-6 rounded-lg '>
                ...
                <h3 className='text-gray-400 text-sm mb-6'>Please enter your 4 digits pin to confirm booking.</h3>
                <h3 className='text-gray-400 text-sm mb-2 text-center'>Enter your 4-digit card pin to confirm this payment</h3>
